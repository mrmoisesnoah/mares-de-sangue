...
async function telaHome(){
  ...
  layout(topo+favHtml+mundosHtml+contHtml+novHtml);
}
...
function imgPop(){ if(_imgPop) return _imgPop; var d=document.createElement("div"); d.className="img-pop"; d.innerHTML='<div class="img-pop-row"><span class="img-pop-lab">Tamanho</span><button type="button" data-tam="30%">P</button><button type="button" data-tam="50%">M</button><button type="button" data-tam="75%">G</button><button type="button" data-tam="100%">Total</button></div><div class="img-pop-row"><span class="img-pop-lab">Posicao</span><button type="button" data-alin="" title="Esquerda">&#8592;</button><button type="button" data-alin="center" title="Centro">&#9744;</button><button type="button" data-alin="right" title="Direita">&#8594;</button></div>'; d.addEventListener("mousedown",function(e){ e.preventDefault(); }); d.addEventListener("click",function(e){ var b=e.target.closest?e.target.closest("button"):null; if(!b) return; if(b.hasAttribute("data-tam")) imgTam(b.getAttribute("data-tam")); else if(b.hasAttribute("data-alin")) imgAlin(b.getAttribute("data-alin")); }); document.body.appendChild(d); _imgPop=d; return d; }
