...
var _imgEl=null,_imgQ=null,_imgPop=null,_imgElPrev=null;
...
function mostrarImgPop(q,img){ _imgQ=q; _imgEl=img; var p=imgPop(); if(_imgElPrev) _imgElPrev.classList.remove("img-sel"); img.classList.add("img-sel"); _imgElPrev=img; p.style.display="block"; reposImgPop(); }
function reposImgPop(){ if(!_imgPop||!_imgEl||_imgPop.style.display==="none") return; var r=_imgEl.getBoundingClientRect(); var top=r.top-_imgPop.offsetHeight-8; if(top<8) top=r.bottom+8; _imgPop.style.top=top+"px"; _imgPop.style.left=Math.max(8,r.left)+"px"; }
function esconderImgPop(){ if(_imgPop) _imgPop.style.display="none"; if(_imgElPrev){ _imgElPrev.classList.remove("img-sel"); _imgElPrev=null; } _imgEl=null; }
